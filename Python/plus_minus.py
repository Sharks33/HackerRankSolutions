...
tot_plus = [i for i in arr if i > 0]
tot_minus = [i for i in arr if i < 0]
tot_zero = [i for i in arr if i == 0]

print round(len(tot_plus) / float(n), 6)
print round(len(tot_minus) / float(n), 6)
print round(len(tot_zero) / float(n), 6)
